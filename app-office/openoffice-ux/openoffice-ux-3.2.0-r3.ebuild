...
MY_PV3="${PV}-${BUILDID}"
BASIS="ooobasis3.2"
MST="OpenOffice.ux.pl-${MY_PV}-rpms/"
...
SRC_URI="ftp://ftp.task.gda.pl/site/openoffice-ux/OOo-3.2.0-3-rpm-linux-ux.pl.tar.bz2"
...
#!!!dodać:	!app-office/openoffice-bin
...
src_unpack() {
	...
	rpm_unpack "./${UP}/desktop-integration/openoffice.ux.pl3.2-freedesktop-menus-3.2-${BUILDID}.noarch.rpm"
